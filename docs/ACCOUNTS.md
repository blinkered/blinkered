...
- Length bounds, and a character set decided on purpose. Twenty-five interface languages argues for
...
Four difficulties, twenty-five languages, two periods, per engine version. That is the grouping
