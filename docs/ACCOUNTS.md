...
- Length bounds, and a character set decided on purpose. Twenty-one interface languages argues for
...
Four difficulties, twenty-one languages, two periods, per engine version. That is the grouping
