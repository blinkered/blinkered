...
- Length bounds, and a character set decided on purpose. Twenty-six interface languages argues for
...
Four difficulties, twenty-six languages, two periods, per engine version. That is the grouping
