# Provenance: Português (pt)

Generated by `pnpm dictionary build --language=pt`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 16107 words, counted toward the board's word floor |
| full tier | 134775 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 (common), undefined (full) |
| validation yield | 80.5% at the common cut, 26.5% at the full cut |
| corpus coverage | 93.9% of all occurrences |
| board density | median 140 words on 12 tiles, 97.3% hold a six-letter word |
...
Group 1:
- hunspell `pt-PT` (MPL-1.1) — Natura project, Universidade do Minho
