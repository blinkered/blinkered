...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-de` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-de |
| commit | [`a0a937b719f6`](https://github.com/blinkered/blinkered-dictionary-de/commit/a0a937b719f68f4a06f12d0bf09d45aa92fbfdf6) |
| committed | 2026-09-21T22:36:55Z |
| blob | `e94786e4f14802253b88bbead51213df0fef73db` |
...
`blinkered/blinkered-dictionary-de` says so, in its own `status.json`, decided 2026-09-21:
...
Every word here is attested: three independent collections of Deutsch text were found to
