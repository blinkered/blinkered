# Provenance: Français (fr)

Generated by `pnpm dictionary build --language=fr`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 16593 words, counted toward the board's word floor |
| full tier | 144105 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 (common), undefined (full) |
| validation yield | 83.0% at the common cut, 25.4% at the full cut |
| corpus coverage | 95.0% of all occurrences |
| board density | median 153 words on 12 tiles, 98.7% hold a six-letter word |
...
Group 1:
- hunspell `fr` (MPL-2.0) — Dicollecte / Grammalecte, Olivier R.
