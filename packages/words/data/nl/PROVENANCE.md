# Provenance: Nederlands (nl)

Generated by `pnpm dictionary build --language=nl`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 16334 words, counted toward the board's word floor |
| full tier | 322146 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 (common), undefined (full) |
| validation yield | 81.7% at the common cut, 39.6% at the full cut |
| corpus coverage | 95.4% of all occurrences |
| board density | median 142 words on 12 tiles, 97.3% hold a six-letter word |
...
Group 1:
- hunspell `nl` (BSD-3-Clause) — OpenTaal
