# Provenance: Ελληνικά (el)

Generated by `pnpm dictionary build --language=el`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17421 words, counted toward the board's word floor |
| full tier | 257014 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 (common), undefined (full) |
| validation yield | 87.1% at the common cut, 33.3% at the full cut |
| corpus coverage | 95.4% of all occurrences |
| board density | median 97 words on 12 tiles, 96.0% hold a six-letter word |
...
Group 1:
- hunspell `el` (MPL-1.1) — Ελληνικός ορθογράφος, Steve Stavropoulos
