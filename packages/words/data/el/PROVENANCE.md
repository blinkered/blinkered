...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-el` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-el |
| commit | [`7218bef73e67`](https://github.com/blinkered/blinkered-dictionary-el/commit/7218bef73e6792684468797e6f050003aa586196) |
| committed | 2026-09-23T22:30:58Z |
| blob | `3fd0456c682283b3c8d479a80ac2cd1ef3124a91` |
...
`blinkered/blinkered-dictionary-el` says so, in its own `status.json`, decided 2026-09-23:
...
Every word here is attested: three independent collections of Ελληνικά text were found to
