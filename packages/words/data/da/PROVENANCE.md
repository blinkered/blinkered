...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-da` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-da |
| commit | [`325b232f03ad`](https://github.com/blinkered/blinkered-dictionary-da/commit/325b232f03ade3ab2df54c7dc35386f9533b2a6f) |
| committed | 2026-09-23T21:37:05Z |
| blob | `520f81b83795658084f860f2cf29fa67db3a3bb7` |
...
`blinkered/blinkered-dictionary-da` says so, in its own `status.json`, decided 2026-09-23:
...
Every word here is attested: three independent collections of Dansk text were found to
