...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-id` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-id |
| commit | [`41383d1d0c65`](https://github.com/blinkered/blinkered-dictionary-id/commit/41383d1d0c655037f821deb7d35a49b2261dce42) |
| committed | 2026-09-22T04:24:56Z |
| blob | `3236244ce94c88cb0f3c23010c55dbec51d60f3f` |
...
`blinkered/blinkered-dictionary-id` says so, in its own `status.json`, decided 2026-09-21:
...
Every word here is attested: three independent collections of Bahasa Indonesia text were found to
