...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-ro` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-ro |
| commit | [`95a508d3d7c6`](https://github.com/blinkered/blinkered-dictionary-ro/commit/95a508d3d7c61278102c47cb88284bda3709726c) |
| committed | 2026-09-22T23:32:19Z |
| blob | `765f0eb4e2ef32d7295dafd63b68d2bea95ca607` |
...
`blinkered/blinkered-dictionary-ro` says so, in its own `status.json`, decided 2026-09-22:
...
Every word here is attested: three independent collections of Română text were found to
