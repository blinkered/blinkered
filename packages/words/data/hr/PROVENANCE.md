# Provenance: Hrvatski (hr)

Generated by `pnpm dictionary build --language=hr`. Do not edit `words.txt` by
...
| | |
| --- | --- |
| common tier | 17613 words, counted toward the board's word floor |
| full tier | 341040 words, accepted for credit |
| length | 3 to 16 tiles |
| candidate cut | rank 20000 (common), undefined (full) |
| validation yield | 88.1% at the common cut, 28.2% at the full cut |
| corpus coverage | 92.8% of all occurrences |
| board density | median 99 words on 12 tiles, 95.3% hold a six-letter word |

## Sources

**Ordering.** hermitdave/FrequencyWords, from the OpenSubtitles 2018 corpus via OPUS, MIT.
`https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/hr/hr_full.txt`
...
Group 1:
- hunspell `hr` (SISSL) — Denis Lackovic and contributors
