...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-cy` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-cy |
| commit | [`10edc8a2d964`](https://github.com/blinkered/blinkered-dictionary-cy/commit/10edc8a2d9643ad705754353318a0f2ac09606fb) |
| committed | 2026-09-24T01:09:10Z |
| blob | `ce6a059a4f3566a56f5ea848abbfb792e53ed94a` |
...
`blinkered/blinkered-dictionary-cy` says so, in its own `status.json`, decided 2026-09-23:
...
Every word here is attested: three independent collections of Cymraeg text were found to
