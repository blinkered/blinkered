...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-hu` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-hu |
| commit | [`98ec7b4cb8bb`](https://github.com/blinkered/blinkered-dictionary-hu/commit/98ec7b4cb8bb7bdb13df6af6b91815bc6428c5fb) |
| committed | 2026-09-22T23:47:26Z |
| blob | `af345ab046603fc3528ea56caeb5def25fb8c45a` |
...
`blinkered/blinkered-dictionary-hu` says so, in its own `status.json`, decided 2026-09-22:
...
Every word here is attested: three independent collections of Magyar text were found to
