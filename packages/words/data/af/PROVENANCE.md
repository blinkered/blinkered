...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-af` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-af |
| commit | [`12b7534c7ba5`](https://github.com/blinkered/blinkered-dictionary-af/commit/12b7534c7ba58a2c473ef91c6ead2120ae1f5cbe) |
| committed | 2026-09-23T20:42:58Z |
| blob | `562cc62ce6af494cd50b1fff67aa626bd2ff660e` |
...
`blinkered/blinkered-dictionary-af` says so, in its own `status.json`, decided 2026-09-23:
...
Every word here is attested: three independent collections of Afrikaans text were found to
