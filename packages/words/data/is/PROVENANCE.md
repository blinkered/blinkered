...
Borrowed, not built. This list is a copy of what `blinkered/blinkered-dictionary-is` publishes on its main
branch, and that repository is where it is made, measured and argued about.

| | |
| --- | --- |
| upstream | https://github.com/blinkered/blinkered-dictionary-is |
| commit | [`c3a1dfa4fa96`](https://github.com/blinkered/blinkered-dictionary-is/commit/c3a1dfa4fa96cdf6a2a058a3b31ed0f706f9a014) |
| committed | 2026-09-23T21:06:26Z |
| blob | `4d9b07fdfe5f5b8a738584256d9b2b04178321d4` |
...
`blinkered/blinkered-dictionary-is` says so, in its own `status.json`, decided 2026-09-23:
...
Every word here is attested: three independent collections of Íslenska text were found to
