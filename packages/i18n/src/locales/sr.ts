...
export const sr: Messages = {
  ...
  htHideBody:
    'На тежим нивоима откривено слово може само да се преврне и да се врати касније у кругу. Тајмер за то добија додатну цртицу, у црвеном. Слово које је већ у твојој речи је безбедно.',
