...
export const fa: Messages = {
  ...
  htHideBody:
    'در سطوح سخت‌تر یک حرف رو شده می‌تواند خودش برگردد و بعدتر در همان دور باز شود. زمان‌سنج برای آن یک تیک قرمز اضافه می‌گیرد. حرفی که در واژه شماست در امان است.',
