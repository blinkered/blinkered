...
export const ar: Messages = {
  ...
  htHideBody:
    'في المستويات الأصعب يمكن لحرف مكشوف أن يُغلق من تلقاء نفسه ثم يعود لاحقًا في الجولة. يُضاف إلى المؤقّت نبض بالأحمر مقابل ذلك. والحرف الموجود في كلمتك آمن.',
