...
export const nl: Messages = {
  ...
  htSwapBody:
    'Tussen de rondes wisselt één tegel van letter. Je ziet welke weggaat en welke komt, maar niet waar hij ligt. De letters die je onthouden hebt, liggen er misschien niet meer.',
