...
export const hr: Messages = {
  ...
  letterHidden: 'jedno se slovo skrilo',
  ...
  hideChance: 'vjerojatnost skrivanja slova',
  ...
  tutChangeTitle: 'Slova se mogu mijenjati',
  tutSameLetters:
    'Uočili ste riječ koju niste stigli odigrati? Ista slova vraćaju se u sljedećoj rundi, promiješana na nova mjesta.',
