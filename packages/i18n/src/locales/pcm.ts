...
export const pcm: Messages = {
  ...
  letterHidden: 'one letter go hide',
  ...
  hideChance: 'chance for letter go hide',
  ...
  tutGoalTitle: 'Blinkered na race',
  tutGoalBody:
  ...
  tutChangeTitle: 'Letters fit change',
  tutSameLetters:
    'You see word wey you no get chance play? Di same letters go come back next round, shuffle enter new places.',
