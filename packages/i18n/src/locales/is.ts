...
export const is: Messages = {
  ...
  hideChance: 'líkur á að stafur hverfi',
  ...
  tutChangeTitle: 'Stafir geta breyst',
  tutSameLetters:
    'Sástu orð sem þú náðir ekki að spila? Sömu stafirnir koma aftur í næstu umferð, stokkaðir á nýja staði.',
