...
export const mk: Messages = {
  ...
  htHideBody:
    'На потешките нивоа откриена буква може сама да се сврти и да се врати подоцна во кругот. Тајмерот за тоа добива дополнителен такт, во црвено. Буква што е веќе во твојот збор е безопасна.',
