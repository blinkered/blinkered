...
export const sw: Messages = {
  ...
  tutChangeTitle: 'Herufi zinaweza kubadilika',
  tutSameLetters:
    'Umeona neno ambalo hukuwahi kulicheza? Herufi zilezile zinarudi raundi inayofuata, zikiwa zimechanganywa katika nafasi mpya.',
