...
export const it: Messages = {
  ...
  htSwapBody:
    "Tra un turno e l'altro una tessera cambia lettera. Vedi quale se ne va e quale arriva, ma non dove si trova. Le lettere che ricordi potrebbero non esserci più.",
