...
export const sv: Messages = {
  ...
  letterHidden: 'en bokstav gömde sig',
  shuffled: 'blandat',
  ...
  hideChance: 'chans att en bokstav göms',
  ...
  tutGoalTitle: 'Blinkered är en kapplöpning',
  tutGoalBody:
  ...
  tutChangeTitle: 'Bokstäver kan ändras',
  tutSameLetters:
    'Såg du ett ord du inte hann spela? Samma bokstäver kommer tillbaka nästa omgång, blandade på nya platser.',
