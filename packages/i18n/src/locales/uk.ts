...
export const uk: Messages = {
  ...
  htHideBody:
    'На складніших рівнях відкрита літера може сама перевернутися і повернутися згодом у тому ж раунді. Таймер отримує за це додаткову позначку, червону. Літера, яка вже у вашому слові, у безпеці.',
