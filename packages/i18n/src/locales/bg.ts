...
export const bg: Messages = {
  ...
  htHideBody:
    'На по-трудните нива открита буква може сама да се обърне и да се върне по-късно в рунда. Таймерът получава допълнителен такт за това, в червено. Буква, която вече е в думата ви, е в безопасност.',
