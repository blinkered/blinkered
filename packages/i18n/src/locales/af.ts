...
export const af: Messages = {
  ...
  tutChangeTitle: 'Letters kan verander',
  tutSameLetters:
    'Het jy ’n woord raakgesien wat jy nie betyds kon speel nie? Dieselfde letters kom volgende rondte terug, geskommel na nuwe plekke.',
