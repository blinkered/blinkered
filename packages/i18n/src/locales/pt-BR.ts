...
export const ptBR: Messages = {
  ...
  tutSameLetters:
    'Viu uma palavra que não deu tempo de jogar? As mesmas letras voltam na próxima rodada, embaralhadas em novos lugares.',
  ...
  htBoardBody:
    'As peças viram uma a uma, em uma ordem aleatória. As peças à vista servem para formar palavras.',
