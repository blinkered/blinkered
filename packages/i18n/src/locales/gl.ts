...
export const gl: Messages = {
  ...
  letterHidden: 'unha letra agochouse',
  shuffled: 'barallado',
  ...
  hideChance: 'probabilidade de agochar letra',
  ...
  tutGoalTitle: 'Blinkered é unha carreira',
  tutGoalBody:
  ...
  accountTitle: 'A túa conta',
  menuProfile: 'O meu perfil',
  menuGames: 'As miñas partidas',
  menuPublicPage: 'A miña páxina pública',
  menuSignedInAs: 'Sesión iniciada como',
  signIn: 'Iniciar sesión',
  signOut: 'Pechar sesión',
  signInTitle: 'Inicia sesión ou rexístrate',
  signInLead: 'Unha conta garda as túas partidas, en todos os dispositivos.',
  signInKeepGame: 'Inicia sesión para gardar esta partida, e todas as seguintes.',
  continueWithApple: 'Continuar con Apple',
  continueWithGoogle: 'Continuar con Google',
  signInOr: 'ou',
  emailLabel: 'Correo',
  codeLabel: 'Código',
  emailMeACode: 'Enviádeme un código',
  working: 'Un intre…',
  sendNewCode: 'Enviar un código novo',
  codeSent: 'Mira o correo. O código dura 10 minutos.',
  notNow: 'Agora non',
  badEmail: 'Isto non parece un enderezo de correo.',
  ...
  ssoFailed: 'Non funcionou. Téntao outra vez, ou usa o correo.',
  tabProfile: 'Perfil',
  countryAny: 'Prefiro non dicilo',
  findCountry: 'Buscar países',
  usernameLabel: 'Nome de usuario',
  bioLabel: 'Sobre min',
  countryLabel: 'País',
  bioHint: 'Sen ligazóns. {left}/{max}',
  save: 'Gardar',
  saving: 'Gardando…',
  saved: 'Gardado.',
  nameTaken: 'Ese nome xa o ten alguén.',
  nameTooShort: 'Un pouco máis longo, por favor.',
  nameTooLong: 'É longo de máis.',
  nameBadCharacters: 'Só letras, cifras, guións e guións baixos.',
  nameBadEdges: 'Ten que comezar e rematar cunha letra ou unha cifra.',
  nameMixedScripts: 'Escolle un só alfabeto e queda nel.',
  nameReserved: 'Parece un nome dos que damos nós. Escolle outro.',
  nameUnusable: 'Ese nome non se pode usar.',
  bioTooLong: 'Este campo admite {max} caracteres como moito.',
  bioHasLink: 'Aquí non se admiten ligazóns.',
  bioHasControl: 'Contén caracteres que aquí non caben.',
  bioUnusable: 'Ese texto non se pode usar.',
  gamesHeading: 'Partidas',
  gamesEmpty:
    'Aquí aínda non hai nada. As partidas que xogues coa sesión iniciada aparecerán aquí.',
  gamesEmptyShort: 'Aquí aínda non hai nada.',
  gamesLoading: 'Lendo as túas partidas…',
  theirGamesLoading: 'Lendo as súas partidas…',
  profileLoading: 'Lendo o perfil…',
  playerNotFound: 'Aquí non hai ninguén con ese nome.',
  columnWhen: 'Cando',
  columnRounds: 'roldas',
  columnGame: 'Partida',
  gameLoading: 'Lendo a partida…',
  gameUnreadable: 'Non se puido ler esta partida.',
  gameNotRanked: 'Xogada con regras modificadas, así que non entra na clasificación.',
  detailNotKept: 'As palabras e os taboleiros desta partida xa non se gardan.',
  openingBoard: 'O taboleiro inicial',
  roundByRound: 'Rolda a rolda',
  roundNothing: 'non se atopou nada',
  changeReplaced: '{letter} substituída na casa {slot}',
  changeWildOn: '{letter} comodín na casa {slot}',
  changeWildOff: '{letter} comodín retirado da casa {slot}',
  keepThisGame: 'Gardar esta partida',
  savedToYourGames: 'Gardada nas túas partidas.',

  reportThis: 'Denunciar',
  reportHeading: 'Denunciar isto',
  reportTheName: 'O nome',
  reportTheBio: 'A descrición',
  reportTheScore: 'A puntuación',
  reportWhy: 'Que ten de malo? Opcional.',
  reportSend: 'Enviar a denuncia',
  reportSent: 'Grazas. Alguén o revisará.',
  reportSignIn: 'Inicia sesión para denunciar algo.',
  reportGone: 'Iso xa non está.',
  reportCancel: 'Cancelar',

  deleteAccount: 'Eliminar a miña conta',
  deleteAccountWhat:
    'Isto elimina o teu perfil e todas as partidas que gardaches, para sempre. Non se pode desfacer.',
  deleteAccountAsk: 'Envíame un código',
  deleteConfirm: 'Eliminar para sempre',
  deleteGone: 'A túa conta xa non existe. Grazas por xogar.',
  deleteNoAddress:
