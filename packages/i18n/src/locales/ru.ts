...
export const ru: Messages = {
  ...
  htSwapBody:
    'Между раундами одна фишка может сменить букву. Поле очищается и показывает букву, которая уходит, и ту, что занимает её место, но никогда не показывает, какая это была фишка. Поле никогда не остаётся прежним надолго, поэтому список его букв быстро устаревает.',
