...
export const ru: Messages = {
  ...
  htHideBody:
    'На сложных уровнях открытая буква может сама перевернуться обратно и вернуться позже в этом же раунде. Таймер получает за это лишнее деление, красное. Буква, которая уже в вашем слове, в безопасности.',
