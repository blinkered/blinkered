...
export const ru: Messages = {
  ...
  htSwapBody:
    'Между раундами одна фишка может сменить букву. Во время раздачи вам один раз показывают, какая это фишка и что на ней было раньше. Поле никогда не остаётся прежним надолго, поэтому список его букв быстро устаревает.',
