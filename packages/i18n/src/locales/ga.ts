...
export const ga: Messages = {
  ...
  letterHidden: 'chuaigh litir i bhfolach',
  shuffled: 'suaite',
  ...
  hideChance: 'seans litir a chur i bhfolach',
  ...
  tutChangeTitle: 'Is féidir le litreacha athrú',
  tutSameLetters:
    'An bhfaca tú focal nach raibh deis agat é a imirt? Tagann na litreacha céanna ar ais sa chéad bhabhta eile, suaite in áiteanna nua.',
