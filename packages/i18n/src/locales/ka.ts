...
export const ka: Messages = {
  ...
  htHideBody:
    'უფრო რთულ დონეებზე ღია ასო თავისით შეიძლება უკან გადაბრუნდეს და მოგვიანებით იმავე რაუნდში დაბრუნდეს. ტაიმერი ამისთვის ერთ დამატებით ნიშანს იღებს, წითლად. ასო, რომელიც უკვე შენს სიტყვაშია, დაცულია.',
