...
export const en: Messages = {
  ...
  htSwapBody:
    'Between rounds, one tile swaps its letter. You see which letter went and which arrived, but not where it sits. The letters you remember may not be there any more.',
