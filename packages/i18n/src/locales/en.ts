...
export const en: Messages = {
  ...
  tutChangeTitle: 'Letters can change',
  tutSameLetters:
    "Spotted a word you didn't get to play? The same letters come back next round, shuffled into new places.",
