...
export const ja: Messages = {
  ...
  htBoardTitle: '盤',
  htBoardBody:
    'もじは決まった順ではなく1枚ずつ表になります。表になったもじで単語を作ります。盤の上では濁点も半濁点もつけて読めるので、「は」は「ば」として使えます。小さい「っ」「ゃ」「ゅ」「ょ」も大きいもじで表します。',
  htWordsTitle: '単語',
  ...
  htHideTitle: 'かくれるもじ',
  htHideBody:
    'むずかしいレベルでは、表になっているもじが自分でうら返り、そのラウンドの後であらためて表になります。そのぶんタイマーの目もりが1つふえ、赤で示されます。すでに選んだもじは、うら返りません。',
  tutHideBody:
    'むずかしいレベルでは、表になっているもじが自分でうら返り、そのラウンドの後であらためて表になります。すでに選んだもじは、うら返りません。',
  ...
  menuProfile: 'プロフィール',
  menuGames: 'プレイ履歴',
  menuPublicPage: '公開ページ',
  menuSignedInAs: 'ログイン中',
  signIn: 'ログイン',
  signOut: 'ログアウト',
  signInTitle: 'ログインまたは登録',
  signInLead: 'アカウントがあれば、どの端末でもゲームが残ります。',
  signInKeepGame: 'ログインすると、このゲームもこれからのゲームも残ります。',
  ...
  emailMeACode: 'コードを送る',
  working: '処理中…',
  sendNewCode: '新しいコードを送る',
  codeSent: 'メールを確認してください。コードは10分間有効です。',
  notNow: 'あとで',
  badEmail: 'メールアドレスではないようです。',
  ...
  ssoFailed: 'うまくいきませんでした。もう一度試すか、メールを使ってください。',
  tabProfile: 'プロフィール',
  countryAny: '答えない',
  findCountry: '国を検索',
  usernameLabel: 'ユーザー名',
  bioLabel: '自己紹介',
  countryLabel: '国',
  bioHint: 'リンクは不可。{left}/{max}',
  save: '保存',
  saving: '保存中…',
  saved: '保存しました。',
  nameTaken: 'その名前は使われています。',
  nameTooShort: 'もう少し長くしてください。',
  nameTooLong: '長すぎます。',
  nameBadCharacters: '使えるのは英数字、ハイフン、アンダースコアだけです。',
  nameBadEdges: '先頭と末尾は文字か数字にしてください。',
  nameMixedScripts: '文字体系は一つに揃えてください。',
  nameReserved: 'こちらが配る名前に似ています。別の名前にしてください。',
  nameUnusable: 'その名前は使えません。',
  bioTooLong: '自己紹介は{max}文字までです。',
  bioHasLink: '自己紹介にリンクは書けません。',
  bioHasControl: '自己紹介に入れられない文字が含まれています。',
  bioUnusable: 'その自己紹介は使えません。',
  gamesHeading: 'ゲーム',
  gamesEmpty: 'まだ何もありません。ログイン中に遊んだゲームがここに並びます。',
  gamesEmptyShort: 'まだ何もありません。',
  gamesLoading: 'ゲームを読み込み中…',
  theirGamesLoading: 'このプレイヤーのゲームを読み込み中…',
  profileLoading: 'プロフィールを読み込み中…',
  playerNotFound: 'その名前の人はいません。',
  columnWhen: 'いつ',
  columnRounds: 'ラウンド',
  columnGame: 'ゲーム',
  gameLoading: 'ゲームを読み込み中…',
  gameUnreadable: 'このゲームは読み込めませんでした。',
  gameNotRanked: 'ルールを変えて遊んだゲームなので、順位はつきません。',
  detailNotKept: 'このゲームの単語と盤面はもう保存されていません。',
  openingBoard: '最初の盤面',
  roundByRound: 'ラウンドごと',
  roundNothing: '見つからず',
  changeReplaced: '{slot}番目が{letter}に入れ替わりました',
  changeWildOn: '{slot}番目の{letter}がワイルドに',
  changeWildOff: '{slot}番目の{letter}のワイルドが外れました',
