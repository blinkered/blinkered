...
export const vi: Messages = {
  ...
  tutChangeTitle: 'Chữ có thể thay đổi',
  tutSameLetters:
    'Thấy một từ mà chưa kịp chơi? Những chữ đó sẽ quay lại ở vòng sau, được xáo vào chỗ mới.',
