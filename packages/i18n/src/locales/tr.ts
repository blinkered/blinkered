...
export const tr: Messages = {
  ...
  letterHidden: 'bir harf saklandı',
  shuffled: 'karıldı',
  ...
  hideChance: 'harf saklanma olasılığı',
  ...
  notRankedPaused: 'Saat durdu, bu yüzden bu oyun sıralanmaz.',
  ...
  menuGames: 'Oyunlarım',
  menuPublicPage: 'Herkese açık sayfam',
  menuSignedInAs: 'Giriş yapıldı:',
  signIn: 'Giriş yap',
  signOut: 'Çıkış yap',
  signInTitle: 'Giriş yap veya kaydol',
  signInLead: 'Hesap oyunlarını saklar, oynadığın her cihazda.',
  signInKeepGame: 'Bu oyunu ve sonrakilerin hepsini saklamak için giriş yap.',
  continueWithApple: 'Apple ile devam et',
  continueWithGoogle: 'Google ile devam et',
  signInOr: 'veya',
  emailLabel: 'E-posta',
  codeLabel: 'Kod',
  emailMeACode: 'Bana bir kod gönderin',
  working: 'Bir saniye…',
  sendNewCode: 'Yeni kod gönder',
  codeSent: 'E-postana bak. Kod 10 dakika geçerli.',
  notNow: 'Şimdi değil',
  ...
  leaderboardRanksHere: 'Bu oyun nerede yer alıyor',
  leaderboardOutside: 'İlk beşin dışında.',
  ...
  ssoFailed: 'Olmadı. Tekrar dene, ya da e-postanı kullan.',
  tabProfile: 'Profil',
  countryAny: 'Söylemeyeyim',
  findCountry: 'Ülke ara',
  usernameLabel: 'Kullanıcı adı',
  bioLabel: 'Hakkımda',
  countryLabel: 'Ülke',
  bioHint: 'Bağlantı yok. {left}/{max}',
  save: 'Kaydet',
  saving: 'Kaydediliyor…',
  saved: 'Kaydedildi.',
  nameTaken: 'Bu ad birinde var.',
  nameTooShort: 'Biraz daha uzun olsun.',
  nameTooLong: 'Çok uzun.',
  nameBadCharacters: 'Yalnızca harf, rakam, kısa çizgi ve alt çizgi.',
  nameBadEdges: 'Bir harf veya rakamla başlayıp bitmeli.',
  nameMixedScripts: 'Tek bir alfabe seç ve ondan şaşma.',
  nameReserved: 'Bu bizim dağıttığımız adlara benziyor. Başka seç.',
  nameUnusable: 'Bu ad kullanılamaz.',
  bioTooLong: 'Hakkımda en çok {max} karakter alır.',
  bioHasLink: 'Burada bağlantıya izin yok.',
  bioHasControl: 'Burada bulunamayacak karakterler içeriyor.',
  bioUnusable: 'Bu metin kullanılamaz.',
  gamesHeading: 'Oyunlar',
  gamesEmpty: 'Burada henüz bir şey yok. Giriş yapmışken oynadığın oyunlar burada görünür.',
  gamesEmptyShort: 'Burada henüz bir şey yok.',
  gamesLoading: 'Oyunların okunuyor…',
  theirGamesLoading: 'Oyunları okunuyor…',
  profileLoading: 'Profil okunuyor…',
  playerNotFound: 'Burada bu adda kimse yok.',
  columnWhen: 'Ne zaman',
  columnRounds: 'tur',
  columnGame: 'Oyun',
  gameLoading: 'Oyun okunuyor…',
  gameUnreadable: 'Bu oyun okunamadı.',
  gameNotRanked: 'Değiştirilmiş kurallarla oynandı, bu yüzden sıralamaya girmiyor.',
  detailNotKept: 'Bu oyunun kelimeleri ve tahtaları artık saklanmıyor.',
  openingBoard: 'Açılış tahtası',
  roundByRound: 'Tur tur',
  roundNothing: 'bir şey bulunamadı',
  changeReplaced: '{letter} {slot}. yuvada değişti',
  changeWildOn: '{letter} {slot}. yuvada joker',
  changeWildOff: '{letter} joker {slot}. yuvadan gitti',
