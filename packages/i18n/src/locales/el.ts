...
export const el: Messages = {
  ...
  htSwapBody:
    'Ανάμεσα στους γύρους ένα πλακίδιο αλλάζει γράμμα. Βλέπετε ποιο φεύγει και ποιο έρχεται, αλλά όχι πού βρίσκεται. Μάθετε το ταμπλό απέξω και θα σας ξεγελάσει.',
