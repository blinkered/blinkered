...
export const el: Messages = {
  ...
  htSwapBody:
    'Μερικές φορές, ανάμεσα στους γύρους, ένα πλακίδιο αλλάζει γράμμα. Βλέπετε ποιο φεύγει και ποιο έρχεται, αλλά όχι πού βρίσκεται. Τα γράμματα που θυμάστε μπορεί να μην είναι πια εκεί.',
