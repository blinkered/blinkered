...
export const el: Messages = {
  ...
  htSwapBody:
    'Ανάμεσα στους γύρους ένα πλακίδιο μπορεί να αλλάξει γράμμα. Καθώς μοιράζεται το ταμπλό, σας δείχνεται μία φορά ποιο πλακίδιο είναι και τι είχε πάνω του πριν. Το ταμπλό δεν μένει ποτέ ίδιο για πολύ, οπότε μια λίστα με τα γράμματά του παλιώνει γρήγορα.',
