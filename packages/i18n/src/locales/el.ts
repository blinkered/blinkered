...
export const el: Messages = {
  ...
  tapToSelect: 'αγγίξτε ένα γράμμα για να το πάρετε, και το τελευταίο ξανά για να το δώσετε πίσω',
  ...
  htTouchBody:
    'Αγγίξτε ένα αναποδογυρισμένο πλακίδιο για να πάρετε το γράμμα του. Αγγίξτε το τελευταίο γράμμα ξανά για να το δώσετε πίσω. Η Υποβολή λέξης και ο Καθαρισμός βρίσκονται κάτω από το ταμπλό.',
