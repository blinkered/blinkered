...
export const el: Messages = {
  ...
  tutDoneTitle: 'Αυτό είναι όλο το παιχνίδι',
  tutDoneBody: 'Διαλέξτε επίπεδο και παίξτε. Οι οδηγίες είναι πάντα στη γραμμή τίτλου.',
  htBoardTitle: 'Το ταμπλό',
  htBoardBody:
    'Τα πλακίδια γυρίζουν ένα κάθε φορά, με τη σειρά ανάγνωσης. Από τα ανοιχτά πλακίδια σχηματίζετε λέξεις.',
