...
export const el: Messages = {
  ...
  htWildBody:
    'Μερικά πλακίδια γυρίζουν ως μπαλαντέρ αντί για γράμμα. Ο μπαλαντέρ μετράει ως το γράμμα που φτιάχνει λέξη, επιλεγμένο ανάμεσα σε όσα ταιριάζουν, και ποιο ήταν το βλέπετε όταν η λέξη εμφανιστεί στη λίστα σας. Λέξη που έχετε ήδη βρει δεν μετράει.',
  htSwapTitle: 'Τα γράμματα αλλάζουν',
  htSwapBody:
    'Ανάμεσα στους γύρους ένα πλακίδιο μπορεί να αλλάξει γράμμα. Το ταμπλό καθαρίζει και σας δείχνει το γράμμα που φεύγει και εκείνο που παίρνει τη θέση του, αλλά ποτέ ποιο πλακίδιο ήταν. Το ταμπλό δεν μένει ποτέ ίδιο για πολύ, οπότε μια λίστα με τα γράμματά του παλιώνει γρήγορα.',
  htLevelsTitle: 'Τα επίπεδα',
  htLevelEasy:
    'Τα ίδια δώδεκα γράμματα σε όλο το παιχνίδι, οπότε προλαβαίνετε να τα μάθετε και να κρατάτε μια λίστα λέξεων στο μυαλό σας. Τα πλακίδια γυρίζουν αργά και το γεμάτο ταμπλό μένει ορατό αρκετή ώρα για να σχεδιάσετε μια λέξη.',
  htLevelMedium:
    'Πού και πού ένα γράμμα αλλάζει, και η λίστα που κρατούσατε δεν ισχύει πια. Λιγότερος χρόνος για να δείτε και λιγότερος για να σκεφτείτε.',
  htLevelHard:
  ...
  htLevelInsane:
    'Όλα μαζί, στη μέγιστη ταχύτητα. Το ταμπλό χάνεται σχεδόν μόλις συμπληρωθεί, και δεν υπάρχει χρόνος να συγκρατήσετε τίποτα.',
