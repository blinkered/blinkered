...
export const no: Messages = {
  ...
  htSwapBody:
    'Mellom rundene bytter en brikke bokstav. Du ser hvilken som går og hvilken som kommer, men ikke hvor den ligger. Bokstavene du husker, er kanskje ikke der lenger.',
