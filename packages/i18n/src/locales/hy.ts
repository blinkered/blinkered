...
export const hy: Messages = {
  ...
  htHideBody:
    'Ավելի դժվար մակարդակներում բացված տառը կարող է ինքնուրույն հետ շրջվել և վերադառնալ ավելի ուշ նույն փուլում։ Ժամաչափը դրա համար ստանում է լրացուցիչ նշիկ՝ կարմիրով։ Քո բառում արդեն եղած տառը ապահով է։',
