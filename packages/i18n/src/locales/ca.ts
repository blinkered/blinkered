...
export const ca: Messages = {
  ...
  letterHidden: 'una lletra s’ha ocultat',
  shuffled: 'barrejat',
  ...
  hideChance: 'probabilitat d’ocultació de lletra',
  ...
  htHideBody:
    'En els nivells més difícils una lletra visible es pot tornar a girar sola i tornar més tard dins la ronda. El temporitzador guanya un tic per això, en vermell. Les lletres ja triades no es giren.',
  tutHideBody:
    'En els nivells més difícils una lletra visible es pot tornar a girar sola i tornar més tard dins la ronda. Les lletres ja triades no es giren.',
  ...
  menuProfile: 'El meu perfil',
  menuGames: 'Les meves partides',
  menuPublicPage: 'La meva pàgina pública',
  menuSignedInAs: 'Sessió iniciada com a',
  signIn: 'Inicia la sessió',
  signOut: 'Tanca la sessió',
  signInTitle: "Inicia la sessió o registra't",
  signInLead: 'Un compte guarda les teves partides, a tots els dispositius.',
  signInKeepGame: 'Inicia la sessió per guardar aquesta partida, i totes les següents.',
  continueWithApple: 'Continua amb Apple',
  continueWithGoogle: 'Continua amb Google',
  signInOr: 'o',
  emailLabel: 'Correu',
  codeLabel: 'Codi',
  emailMeACode: 'Envieu-me un codi',
  working: 'Un moment…',
  sendNewCode: 'Envia un codi nou',
  codeSent: 'Mira el correu. El codi dura 10 minuts.',
  notNow: 'Ara no',
  badEmail: 'Això no sembla una adreça de correu.',
  badCode:
  ...
  ssoFailed: 'No ha funcionat. Torna-ho a provar, o fes servir el correu.',
  tabProfile: 'Perfil',
  countryAny: 'Prefereixo no dir-ho',
  findCountry: 'Cerca països',
  usernameLabel: "Nom d'usuari",
  bioLabel: 'Sobre mi',
  countryLabel: 'País',
  bioHint: 'Sense enllaços. {left}/{max}',
  save: 'Desa',
  saving: "S'està desant…",
  saved: 'Desat.',
  nameTaken: 'Aquest nom ja el té algú.',
  nameTooShort: 'Una mica més llarg, si us plau.',
  nameTooLong: 'És massa llarg.',
  nameBadCharacters: 'Només lletres, xifres, guions i guions baixos.',
  nameBadEdges: 'Ha de començar i acabar amb una lletra o una xifra.',
  nameMixedScripts: "Tria un sol alfabet i queda-t'hi.",
  nameReserved: "Sembla un nom dels que donem nosaltres. Tria'n un altre.",
  nameUnusable: 'Aquest nom no es pot fer servir.',
  bioTooLong: 'Aquest camp admet {max} caràcters com a màxim.',
  bioHasLink: "Aquí no s'hi admeten enllaços.",
  bioHasControl: 'Conté caràcters que aquí no hi caben.',
  bioUnusable: 'Aquest text no es pot fer servir.',
  gamesHeading: 'Partides',
  gamesEmpty:
    'Aquí encara no hi ha res. Les partides que juguis amb la sessió iniciada sortiran aquí.',
  gamesEmptyShort: 'Aquí encara no hi ha res.',
  gamesLoading: "S'estan llegint les teves partides…",
  theirGamesLoading: "S'estan llegint les seves partides…",
  profileLoading: "S'està llegint el perfil…",
  playerNotFound: 'Aquí no hi ha ningú amb aquest nom.',
  columnWhen: 'Quan',
  columnRounds: 'rondes',
  columnGame: 'Partida',
  gameLoading: "S'està llegint la partida…",
  gameUnreadable: "No s'ha pogut llegir aquesta partida.",
  gameNotRanked: 'Jugada amb regles modificades, així que no es classifica.',
  detailNotKept: "Les paraules i els taulers d'aquesta partida ja no es guarden.",
  openingBoard: 'El tauler inicial',
  roundByRound: 'Ronda a ronda',
  roundNothing: "no s'ha trobat res",
  changeReplaced: '{letter} substituïda a la casella {slot}',
  changeWildOn: '{letter} comodí a la casella {slot}',
  changeWildOff: '{letter} comodí retirat de la casella {slot}',
